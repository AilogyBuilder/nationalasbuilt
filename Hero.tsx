    ...
    <section className="section bg-slate-950 text-white">
      <div className="container-shell flex flex-col items-start justify-between gap-6 rounded-[2rem] border border-white/10 bg-white/5 p-8 lg:flex-row lg:items-center">
        <div className="max-w-2xl">
          <h2 className="text-3xl font-semibold tracking-tight">Ready to get accurate as-built drawings for your project?</h2>
          <p className="mt-3 text-lg leading-8 text-slate-300">
            Call or email our team today. We schedule surveys within 48 hours and deliver permit-ready drawings fast.
          </p>
        </div>
